...
CCharacter *CGameWorld::IntersectCharacter(vector2_base<EngineFloat> Pos0, vector2_base<EngineFloat> Pos1, float Radius, vector2_base<EngineFloat> &NewPos, CCharacter *pNotThis, int CollideWith, class CCharacter *pThisOnly)
{
	// Find other players
