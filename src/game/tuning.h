...
// physics tuning
MACRO_TUNING_PARAM(GroundControlSpeed, ground_control_speed, 500.0 / 50, "Max speed the tee can get on ground")
MACRO_TUNING_PARAM(GroundControlAccel, ground_control_accel, 100.0 / TicksPerSecond, "Acceleration speed on the ground")
MACRO_TUNING_PARAM(GroundFriction, ground_friction, pow((double)0.5, 1.0/((double)TicksPerSecond / 50.0)), "Friction on the ground")
MACRO_TUNING_PARAM(GroundJumpImpulse, ground_jump_impulse, 660.0 / 50, "Impulse when jumping on ground")
MACRO_TUNING_PARAM(AirJumpImpulse, air_jump_impulse, 600.0 / 50, "Impulse when jumping in air")
MACRO_TUNING_PARAM(AirControlSpeed, air_control_speed, 250.0 / 50, "Max speed the tee can get in the air")
MACRO_TUNING_PARAM(AirControlAccel, air_control_accel, 75.0 / TicksPerSecond, "Acceleration speed in air")
MACRO_TUNING_PARAM(AirFriction, air_friction, pow((double)0.95, 1.0/((double)TicksPerSecond / 50.0)), "Friction in the air")
MACRO_TUNING_PARAM(HookLength, hook_length, 380.0, "Length of the hook")
MACRO_TUNING_PARAM(HookFireSpeed, hook_fire_speed, 4000.0 / TicksPerSecond, "How fast the hook is fired")
MACRO_TUNING_PARAM(HookDragAccel, hook_drag_accel, 150.0 / TicksPerSecond, "Acceleration when hook is stuck")
MACRO_TUNING_PARAM(HookDragSpeed, hook_drag_speed, 750.0 / 50, "Drag speed of the hook")
MACRO_TUNING_PARAM(Gravity, gravity, 25.0 / TicksPerSecond, "Gravity of the teeworld")
