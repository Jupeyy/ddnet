...
void CMenus::RenderSettingsGraphics(CUIRect MainView)
{
	...
	const int NewWindowMode = RenderDropDown(s_WindowModeDropDownState, &MainView, OldSelected, aWindowModeIDs, pWindowModes, s_NumWindowMode, &s_NumWindowMode, s_ScrollValue);
