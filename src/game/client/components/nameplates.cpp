	...
	const CNetObj_PlayerInfo *pPlayerInfo)
{
	...
	if(ClientID >= 0 && ClientID < MAX_CLIENTS)
		...
		Position = mix(vec2(pPrevChar->m_X / FRAGMENT_DEVIDER, pPrevChar->m_Y / FRAGMENT_DEVIDER), vec2(pPlayerChar->m_X / FRAGMENT_DEVIDER, pPlayerChar->m_Y / FRAGMENT_DEVIDER), Client()->IntraGameTick(g_Config.m_ClDummy));
